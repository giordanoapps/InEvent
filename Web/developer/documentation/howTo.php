...
<div class="documentationBox documentationBoxSelected">
    ...
    <h3>Exemplo de documentação</h3>
        ...
        <div class="documentationFunctionBox">
            <p class="documentFunctionName">
                ...
                <img src="../images/64-Chemical.png" alt="Try it out!" class="tryItOut" data-get="method=person.signIn&email=Nome&password=Senha">
            </p>
            ...
            <div class="documentationFunctionParametersBox">
                <p><b>email</b><sub>GET</sub> : email de membro</p>
    ...
    <h3>Explicação</h3>
        <p>Existem três seções demarcadas: <b>cabeçalho, retorno e parâmetros</b>, cada qual sendo explicada separadamente:</p>
            <ul>
                <li>O <b>cabeçalho</b> (member.signIn) apresenta a chamada, composto de um <u>namespace</u> (email) e seu <u>método</u> (signIn). A chamada deve ser enviada ao servidor através do parâmetro method via GET, para que seja identificada o tipo de informação que o cliente deseja.</li>
    ...
    <h3>Notas</h3>
        <p>A API do <b>InEvent</b> utiliza um RPC-REST híbrido, utilizando o POST carregado como forma de enviar dados que necessitem ser escritos.</p>
        ...
        <ul>
            ...
            <li><i>excel</i> : arquivo no formato Excel 2007, com Content-Type:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet </li>
        </ul>
