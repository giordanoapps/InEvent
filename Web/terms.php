...
<body>
	...
	<div id="content">
		...
		<div id="termsContent" class="pageContent">
			
			<div class="titleContent">Termos de Uso</div>
			...
			<div class="boardContent">
				<div class="boardContentInnerWrapper">
					...
					<div class="pageContentBox shrinkInnerWrapper">
						...
						<p>Pagamento: Todos os planos referidos na cláusula acima devem ter seu pagamento efetuado em um prazo de no máximo 7 (SETE) dias úteis após a data de emissão da cobrança, sob pena de suspensão caso tal pagamento não seja efetuado, caso nenhum outro acordo esteja em vigor.</p>
						
						<p>Privacidade: As informações fornecidas pelo contratante ao Estúdio Trilha são de responsabilidade confidencial, ficando a cargo do Estúdio Trilha resguardar elas em local seguro.</p>

						<h3>Avisos legais</h3>

						<p>O PRESENÇA NÃO GARANTE QUE O PRESENÇA E SEUS SERVIÇOS ESTÃO LIVRES DE ERROS OU FUNCIONARÃO DE FORMA ININTERRUPTA. O PRESENÇA É FORNECIDO "NO ESTADO EM QUE SE ENCONTRA" E "CONFORME DISPONÍVEL". TODAS AS INFORMAÇÕES CONTIDAS NO PRESENÇA ESTÃO SUJEITAS A ALTERAÇÃO SEM AVISO PRÉVIO. O PRESENÇA NÃO PODE GARANTIR QUE O PRESENÇA, SEU WEBSITE, OU APLICATIVOS ESTÃO LIVRES DE VÍRUS OU DE FUNCIONALIDADES PREJUDICIAIS. O PRESENÇA RENUNCIA A TODAS AS GARANTIAS, EXPRESSAS OU IMPLÍCITAS, INCLUINDO QUAISQUER GARANTIAS DE PRECISÃO, NÃO VIOLAÇÃO, COMERCIABILIDADE E ADEQUAÇÃO A UMA FINALIDADE ESPECÍFICA. O PRESENÇA RENUNCIA A TODA E QUALQUER RESPONSABILIDADE PELOS ATOS, OMISSÕES E CONDUTAS DE TERCEIROS RELACIONADOS A SUA UTILIZAÇÃO DO PRESENÇA. VOCÊ É INTEGRAMENTE RESPONSÁVEL PELA SUA UTILIZAÇÃO DO PRESENÇA E QUAISQUER SERVIÇOS OU CONTEÚDOS A ELE RELACIONADOS. O SEU ÚNICO E EXCLUSIVO RECURSO CONTRA O PRESENÇA CASO VOCÊ ESTEJA INSATISFEITO COM O MESMO É INTERROMPER SEU USO. ESTA LIMITAÇÃO FAZ PARTE DO ACORDO ENTRE AS PARTES.</p>

						<p>O aviso legal acima aplica-se a quaisquer danos, responsabilidades ou prejuízos causados por qualquer falha no desempenho, erro, omissão, interrupção, eliminação, defeito, atraso na operação ou transmissão, vírus, avaria na linha de comunicação, roubo ou destruição de ou acesso não autorizado a, alteração de, ou utilização, quer por quebra de contrato, ato ilícito, negligência ou qualquer outra causa pedir.</p>

						<h3>Responsabilidade</h3>

						<p>VOCÊ CONCORDA, EM HIPÓTESE ALGUMA, A IMPUTAR AO PRESENÇA RESPONSABILIDADE PERANTE VOCÊ POR QUALQUER DANO, PERDA OU CAUSAS DE PEDIR, SEJA EM CONTRATO, ATO ILÍCITO (INCLUINDO, SEM LIMITAÇÃO, NEGLIGÊNCIA), OU OUTRO EM VALOR SUPERIOR AO VALOR PAGO POR VOCÊ AO PRESENÇA PELOS ÚLTIMOS 12 (DOZE) MESES DE SERVIÇOS OU R$99,00 (NOVENTE E NOVE REAIS), QUAL FOR MAIOR.</p>

						<h3>Indenização</h3>

						<p>Você concorda em indenizar e manter o PRESENÇA indene contra quaisquer reclamações, ações ou despesas (incluindo honorários advocatícios) imputadas por terceiros ou relacionadas ao seu uso do PRESENÇA.</p>

						<h3>Revogação</h3>

						<p>Você entende e concorda que o PRESENÇA poderá, a seu exclusivo critério e a qualquer momento, revogar sua conta ou seu uso de quaisquer serviço, por qualquer motivo. O PRESENÇA poderá, ainda, descontinuar quaisquer serviços ou limitar ou restringir qualquer acesso, por qualquer motivo. Você concorda que o PRESENÇA poderá tomar uma ou mais destas medida sem qualquer aviso prévio a você. No entanto, em determinados casos, caso um serviço seja descontinuado, desde que isso seja razoavelmente possível, informaremos você com antecedência para que você possa excluir seus dados pessoais relacionados ao serviço que estiver sendo descontinuado. Você entende e concorda que o PRESENÇA não terá qualquer responsabilidade perante você ou qualquer terceiro por qualquer rescisão do seu acesso e/ou remoção de informações relacionadas à sua conta ou serviços.</p>

						<h3>Disposições Gerais</h3>

						<p>Esses Termos serão interpretados e executados de acordo com as leis do Brasil. O tribunal do Estado de São Paulo será competente para dirimir quaisquer questões decorrentes do presente Termo de Uso, os serviços ou o conteúdo.</p>

						<p>Se qualquer disposição desse Termo de Uso for considerada ilegal, nula ou por qualquer razão inexequível, tal disposição será considerada excluída deste documento e não afetará a validade e exeqüibilidade das disposições remanescentes.</p>

						<p>Você, por este instrumento, autoriza expressamente o PRESENÇA a revelar e transferir suas informações armazenadas nos servidores do PRESENÇA ou de terceiros autorizados a qualquer terceiro em razão de qualquer restruturação societária, incluindo, sem limitação, fusão, aquisição ou venda de todos ou substancialmente todos os ativos do PRESENÇA. Você deverá concordar e aceitar todos os termos e condições impostos pelo novo proprietário. O PRESENÇA não terá qualquer responsabilidade perante você após a efetiva cessão dos ativos do PRESENÇA ou do Website para um terceiro interessado.</p>
					</div>
				</div>
			</div>
		</div>
