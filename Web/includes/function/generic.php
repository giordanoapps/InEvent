<?php
    ...
    function getEmptyAttribute($attr) {
    	...
    	if (isset($attr)) {
    		...
    		// Else, we can parse the string
    			...
    			$attribute = trim(htmlentities($attr, ENT_COMPAT | ENT_HTML401, "UTF-8"));
    		} else {
                $attribute = $attr;
            }
    ...
    /**
     * Map a jQuery array inside PHP objects, using keys and values
     * @param  array $arr desorganized array
     * @return array      organized array
     */
	 ...
	 */
    function http_status_code($code = NULL) {
