...
@interface GroupCircleViewController : WrapperViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, InEventAPIControllerDelegate>
